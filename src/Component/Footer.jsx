...
const HBNFooter = () => {
  ...
  return (
    <footer className="hbn-footer">
      {/* ── Contact Section ── */}
      <div
        className="hbn-contact"
        style={{ backgroundImage: "url(https://hbnlogistics.com/wp-content/themes/hbn/images/bg_01.png)" }}
      >
        {/* Left: Image */}
        <div className="hbn-contact__image-col">
          <img
            src="https://hbnlogistics.com/wp-content/themes/hbn/images/getintouch.png"
            alt="Get In Touch"
            className="hbn-contact__image"
          />
        </div>

        {/* Right: Form */}
        <div className="hbn-contact__form-col">
          <span className="hbn-contact__label">/get in touch/</span>
          <h2 className="hbn-contact__heading">
            Have Questions?<br />We're Here to Help!
          </h2>

          <div className="hbn-contact__grid">
            <input
              className="hbn-contact__input"
              type="text"
              name="name"
              placeholder="Name"
              value={form.name}
          ...
          <div className="hbn-contact__actions">
            <button className="hbn-contact__btn-primary" onClick={handleSubmit}>
              Send Message
            </button>
            <button className="hbn-contact__btn-icon" aria-label="Send">
              ➤
            </button>
          </div>
        </div>
